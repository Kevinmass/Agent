...
function hash33(v) {
  ...
  const p_xxy = [p[0], p[0], p[1]], p_yxx = [p[1], p[0], p[0]], p_zyx = [p[2], p[1], p[0]];
  const result = [];
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        iBallCount: { value: ballCount }, iCursorBallSize: { value: cursorBallSize },
        iMetaBalls: { value: metaBallsUniform }, iClumpFactor: { value: clumpFactor },
    ...
    function onPointerEnter() { if (!enableMouseInteraction) return; pointerInside = true; }
    function onPointerLeave() { if (!enableMouseInteraction) return; pointerInside = false; }
