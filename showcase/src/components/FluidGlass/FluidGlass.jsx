...
import { useRef, useState, useEffect, memo, Component } from 'react';
...
const ModeWrapperBase = memo(function ModeWrapperBase({
  children,
  glb,
  geometryKey,
  lockToBottom = false,
...
function ModeWrapper({ glb, geometryKey, ...props }) {
  return (
    <ErrorBoundary fallback={fallbackMesh}>
      <ModeWrapperBase glb={glb} geometryKey={geometryKey} {...props} />
    </ErrorBoundary>
  );
}
